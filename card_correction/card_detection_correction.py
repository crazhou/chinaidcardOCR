...
from .model_resnet18 import CardDetectionCorrectionModel
...
from .utils.device import (create_device, verify_device)
...
class CardDetectionCorrection(Pipeline):
    def __init__(self,
        ...
        infer_model = CardDetectionCorrectionModel()
        ...
        self.infer_model = infer_model.to(self.device).eval()
        # opts = {"device" : "GPU", "config" : {"PERFORMANCE_HINT" : "LATENCY"}}
        # self.infer_model = torch.compile(infer_model)
